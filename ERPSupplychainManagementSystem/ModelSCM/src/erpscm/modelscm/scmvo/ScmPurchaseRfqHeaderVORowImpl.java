...
public class ScmPurchaseRfqHeaderVORowImpl extends ERPViewRowImpl {
    ...
    public static final int SCMPURCHASEBIDHEADERVO1 = AttributesEnum.ScmPurchaseBidHeaderVO1.index();
    ...
    public void setTempProjectId(Integer value) {
        ...
        RowIterator ScmPurchaseRFQLinesVO = getScmPurchaseRfqLinesVO();
        //DepartmentId
        while (ScmPurchaseRFQLinesVO.hasNext()) {
           ScmPurchaseRFQLinesVO.next().setAttribute("ProjectId", value);
        } 
        getDBTransaction().getRootApplicationModule().findViewObject("ScmPurchaseRfqLinesDetCRUD").executeQuery();
    ...
    public void setTempDepartmentId(Integer value) {
        ...
        //DepartmentId
        while (ScmPurchaseRFQLinesVO.hasNext()) {
           ScmPurchaseRFQLinesVO.next().setAttribute("DepartmentId", value);
        } 
        getDBTransaction().getRootApplicationModule().findViewObject("ScmPurchaseRfqLinesDetCRUD").executeQuery();
    ...
    public void setDemandHeaderSno(Integer value) {
        ...
        while(getScmPurchaseRfqLinesVO().getRowCount()>0) {
            getScmPurchaseRfqLinesVO().first().remove();
        }
       
        getAccScmPurchaseDemandLinesForRFQ().setNamedWhereClauseParam("P_ADF_DEMAND_HEADER_SNO", value==null?0:value);
        getAccScmPurchaseDemandLinesForRFQ().executeQuery();
        RowSetIterator erprsi=getAccScmPurchaseDemandLinesForRFQ();
        
        while (erprsi.hasNext()) {
            Row erpNextRow = erprsi.next();
            Row erpNewRow = getScmPurchaseRfqLinesVO().createRow();
            erpNewRow.setAttribute("DemandLinesSno", erpNextRow.getAttribute("DemandLinesSno"));
            erpNewRow.setAttribute("RequiredBy", erpNextRow.getAttribute("RequiredByDate"));
            erpNewRow.setAttribute("RequesterId", erpNextRow.getAttribute("RequesterId"));
            erpNewRow.setAttribute("DepartmentId", erpNextRow.getAttribute("DepartmentId"));
            erpNewRow.setAttribute("ProjectId", erpNextRow.getAttribute("ProjectId"));
            erpNewRow.setAttribute("AproxPrice", erpNextRow.getAttribute("AproxPrice"));
...
//            RowSet erpRowSet =(RowSet )getScmPurchaseRfqLinesVO();
//            erpRowSet.executeQuery();
    }
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link ScmPurchaseBidHeaderVO1.
     */
    public RowIterator getScmPurchaseBidHeaderVO1() {
        return (RowIterator) getAttributeInternal(SCMPURCHASEBIDHEADERVO1);
    }
