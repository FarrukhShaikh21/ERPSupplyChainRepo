...
public class ScmCustomerTypeTaxRateImpl extends EntityImpl {
     ...
     */
    public ScmCustomerTypeTaxRateImpl() {
    }
     ...
     * @return the value of TypeTaxRateSno
     */
    public Integer getTypeTaxRateSno() {
        return (Integer) getAttributeInternal(TYPETAXRATESNO);
    }

    /**
     * Sets <code>value</code> as the attribute value for TypeTaxRateSno.
     * @param value value to set the TypeTaxRateSno
     */
    public void setTypeTaxRateSno(Integer value) {
        setAttributeInternal(TYPETAXRATESNO, value);
    }
    ...
    /**
     * @param typeTaxRateSno key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Integer typeTaxRateSno) {
        return new Key(new Object[] { typeTaxRateSno });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation == DML_INSERT) {
            ...
            String result =
                ERPGlobalPLSQLClass.doGetPrimaryKeyValueModel(getDBTransaction(), "TYPE_TAX_RATE_SNO",
                                                              this.getEntityDef().getSource(), null, null);

            populateAttributeAsChanged(TYPETAXRATESNO, Integer.parseInt(result));
